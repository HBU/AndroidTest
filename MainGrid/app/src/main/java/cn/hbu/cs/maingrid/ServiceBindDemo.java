...
public class ServiceBindDemo extends AppCompatActivity implements View.OnClickListener{
    private ServiceBind.DownloadBinder downloadBinder;
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {//活动与服务成功绑定时调用
            downloadBinder = (ServiceBind.DownloadBinder) service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.service_binddemo);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bind_service_button:
                Intent bindIntent = new Intent(ServiceBindDemo.this, ServiceBind.class);
