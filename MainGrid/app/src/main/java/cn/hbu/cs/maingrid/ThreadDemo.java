...
public class ThreadDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thread_ui);
        ...
        chronoText1 = findViewById(R.id.chronoText1);
        chronoValue1 = findViewById(R.id.chronoValue1);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (value > 0) {// 验证数值是否大于零
                    ...
                    Toast.makeText(ThreadDemo.this, "请输入一个大于零的整数值 !", Toast.LENGTH_LONG).show();
                }
            }
        });
