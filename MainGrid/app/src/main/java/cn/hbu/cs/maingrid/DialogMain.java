...
public class DialogMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textview = findViewById(R.id.textView12345);
        textview.setText(name);
    }
    public void onDialogClick1(View v){
        new AlertDialog.Builder(DialogMain.this)
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DialogMain.this, items[which], Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                }).create();
        dialog.show();
        ...
        AlertDialog dialog = new AlertDialog
                ...
                .setMultiChoiceItems(items1, null, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        ...
                        Toast.makeText(DialogMain.this, "选择了" + itemStr, Toast.LENGTH_SHORT).show();
                        // 关闭对话框
                        //dialog.dismiss();
    ...
    public void onDialogClick4(View v){
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setItems(items1, new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DialogMain.this, items1[which], Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                }).create();
        dialog.show();
    ...
    public void onDialogClick6(View v){
        ...
        DatePickerDialog dpd = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                //当时间被设置后回调的方法
                Toast.makeText(DialogMain.this,
    ...
    public void onDialogClick9(View v){
        DialogMy dialog = new DialogMy(DialogMain.this);
        dialog.show();
    }
    public void onDialogClick10(View v){
        Intent intent = new Intent(DialogMain.this,DialogRadioButton.class);
